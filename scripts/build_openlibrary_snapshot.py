...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.source_dir is None and args.works_dump is None:
        parser.error("either --source-dir or --works-dump is required")

    effective_limit = args.limit if args.limit is not None else (None if args.source_dir is not None else 100_000)
